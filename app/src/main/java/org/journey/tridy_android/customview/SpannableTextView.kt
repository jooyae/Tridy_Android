package org.journey.tridy_android.customview
...
import org.journey.tridy_android.util.CustomTypefaceSpan
...
class SpannableTextView @JvmOverloads constructor(
    ...
    private val typeFace = Typeface.create(ResourcesCompat.getFont(context, R.font.notosanskrbold), Typeface.NORMAL)
