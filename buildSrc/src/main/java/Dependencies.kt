...
object AndroidX {
    ...
    object Room {
        ...
        const val ROOM_RXJAVA2 = "androidx.room:room-rxjava2:${DependencyVersions.ROOM_VERSION}"
...
object Square {
    ...
    const val ADAPTER_RXJAVA = "com.squareup.retrofit2:adapter-rxjava2:${DependencyVersions.RETROFIT_VERSION}"
...
object ReactiveX{
    const val RX_JAVA = "io.reactivex.rxjava2:rxjava:${DependencyVersions.RXJAVA_VERSION}"
    const val RX_ANDROID = "io.reactivex.rxjava2:rxandroid:${DependencyVersions.RXANDROID_VERSION}"
}
